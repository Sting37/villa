        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <div class="card-header">
                            <h5 class="my-0 font-weight-normal">Option 1</h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <small class="text-muted">₱10,000 / 9:00 - 6:00 PM</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <div class="card-header">
                            <h5 class="my-0 font-weight-normal">Option 2</h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <?php } ?>
                                <small class="text-muted">₱15,000 / 8:00 PM - 7:00 AM</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <div class="card-header">
                            <h5 class="my-0 font-weight-normal">Option 3</h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <?php } ?>
                                <small class="text-muted">₱22,000 / 22 Hrs</small>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <select required class="custom-select mr-sm-2"  name="roomType">
                                            <option value="<?php echo \models\RequirementEnum::DELUXE; ?>">Option 1</option>
                                            <option value="<?php echo \models\RequirementEnum::DOUBLE; ?>">Option 2</option>
                                            <option value="<?php echo \models\RequirementEnum::SINGLE; ?>">Option 3</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row align-items-center">
